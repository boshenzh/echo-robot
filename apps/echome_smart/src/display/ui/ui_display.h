...
// Include wakeup UI functions
#include "ui_wakeup.h"
#elif defined(ENABLE_GUI_WECHAT) && (ENABLE_GUI_WECHAT == 1)
// WeChat UI functions are already defined in ui_wechat.c
#elif defined(ENABLE_GUI_CHATBOT) && (ENABLE_GUI_CHATBOT == 1)
// Chatbot UI functions are already defined in ui_chatbot.c
#elif defined(ENABLE_GUI_OLED) && (ENABLE_GUI_OLED == 1)
// OLED UI functions are already defined in ui_oled.c
#elif defined(ENABLE_GUI_EYES) && (ENABLE_GUI_EYES == 1)
// Eyes UI functions are already defined in ui_eyes.c
#endif
